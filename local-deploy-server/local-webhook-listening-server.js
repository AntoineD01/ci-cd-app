...
const repoDir = 'C:/Users/Antoine Dupont/Documents'; // this is where the code will pll your directory code locally just to use the docker-compose.yml file
const repoUrl = 'https://github.com/AntoineD01/ci-cd-app.git';// this is the url of the repo you want to pull the code from
